...
[will-it-scale][]. For external benchmarks, users need to carefully implement adapters (see [adapters config](bm-config.md#adapter)), and
specify path and arguments (see [applications config](bm-config.md#application)).

...
#define PTR_OFFSET                                                             \
    (ctx->mmap_offsets_min_rocks_write_fcntl_7_0_prog - MMAP_OFFSET)
#define UNIQUE_ID min_rocks_write_fcntl_7_0_prog
bool abort_on_fail = false;
#include "syz/min_rocks_write_fcntl_7_0.h"

static inline void
_mkdir_min_rocks_write_fcntl_7_0_prog(thread_ctx_t *ctx, const char *dir)
{
    char tmp[256] = {0};
    char *p       = NULL;
    size_t len    = 0;
...
static inline void
init_subdirs_min_rocks_write_fcntl_7_0_prog(thread_ctx_t *ctx)
{
    for (int i = 0; i < num_subdirs_min_rocks_write_fcntl_7_0_prog; i++) {
        _mkdir_min_rocks_write_fcntl_7_0_prog(
            ctx, subdirs_min_rocks_write_fcntl_7_0_prog[i]);
    }
}

static void __attribute__((noinline))
remove_tmp_dir_min_rocks_write_fcntl_7_0_prog(const char *dir);
static inline void
rm_tmpdir_min_rocks_write_fcntl_7_0_prog(thread_ctx_t *ctx)
{
    remove_tmp_dir_min_rocks_write_fcntl_7_0_prog(
        ctx->tmpdir_min_rocks_write_fcntl_7_0_prog);
}
...
bm_target_reg(thread_ctx_t *ctx, size_t tid)
{
    ...
    chmod(ctx->tmpdir_min_rocks_write_fcntl_7_0_prog,
          S_IRWXU | S_IRWXG | S_IRWXO);
    ctx->dirfd_min_rocks_write_fcntl_7_0_prog =
        open(ctx->tmpdir_min_rocks_write_fcntl_7_0_prog, O_DIRECTORY | O_PATH);
    ...
    assert(num_filenames_min_rocks_write_fcntl_7_0_prog ==
           num_filesizes_min_rocks_write_fcntl_7_0_prog);

    for (int i = 0; i < num_filenames_min_rocks_write_fcntl_7_0_prog; i++) {
        fd_trunc = openat(ctx->dirfd_min_rocks_write_fcntl_7_0_prog,
                          filenames_min_rocks_write_fcntl_7_0_prog[i],
                          O_RDWR | O_CREAT, S_IRWXU | S_IRWXG | S_IRWXO);
        // assert(fd_trunc > 0 && "Could not open file at thread registration");
        if (fd_trunc < 0)
            continue;
        int ret_ft =
            ftruncate(fd_trunc, filesizes_min_rocks_write_fcntl_7_0_prog[i]);
        (void)ret_ft;
        assert(ret_ft == 0);
        close(fd_trunc);
        fd_trunc = 0;
    ...
    if (maxWriteBufferSize_min_rocks_write_fcntl_7_0_prog > 0) {
        ctx->writeBuffer_min_rocks_write_fcntl_7_0_prog = (char *)aligned_alloc(
            maxWriteBufferSizeAlignment_min_rocks_write_fcntl_7_0_prog,
            maxWriteBufferSize_min_rocks_write_fcntl_7_0_prog);
    } else {
        ctx->writeBuffer_min_rocks_write_fcntl_7_0_prog = NULL;
    }

    if (maxWriteBufferSize_min_rocks_write_fcntl_7_0_prog %
            maxWriteBufferSizeAlignment_min_rocks_write_fcntl_7_0_prog !=
        0) {
...
bm_dispatch_operation(thread_ctx_t *ctx, size_t op_id)
{
    ...
    res_all.op_count += ctx->num_succeeded_min_rocks_write_fcntl_7_0_prog +
                        ctx->num_failed_min_rocks_write_fcntl_7_0_prog;

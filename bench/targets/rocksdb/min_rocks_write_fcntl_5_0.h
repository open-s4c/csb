...
struct thread_ctx_s {
  ...
  int num_failed_min_rocks_write_fcntl_5_0_prog;
  uintptr_t mmap_offsets_min_rocks_write_fcntl_5_0_prog;
  char *writeBuffer_min_rocks_write_fcntl_5_0_prog;
  struct sockaddr_in *connect4_arg_min_rocks_write_fcntl_5_0_prog;
  struct sockaddr_in6 *connect6_arg_min_rocks_write_fcntl_5_0_prog;
  struct sockaddr_in *bind4_arg_min_rocks_write_fcntl_5_0_prog;
  struct sockaddr_in6 *bind6_arg_min_rocks_write_fcntl_5_0_prog;
};

uint16_t g_conn_port = 36721;
uint16_t g_bind_port = 46721;

#define PTR_OFFSET (ctx->mmap_offsets_min_rocks_write_fcntl_5_0_prog - MMAP_OFFSET)
#define UNIQUE_ID min_rocks_write_fcntl_5_0_prog
bool abort_on_fail = false;
#include "syz/min_rocks_write_fcntl_5_0.h"

static inline void _mkdir_min_rocks_write_fcntl_5_0_prog(thread_ctx_t *ctx, const char *dir) {
  char tmp[256] = {0};
  char *p = NULL;
  size_t len = 0;
  ...
  for (p = tmp + 1; *p; p++)
    if (*p == '/') {
      *p = 0;
      mkdirat(ctx->dirfd_min_rocks_write_fcntl_5_0_prog, tmp, S_IRWXU);
      *p = '/';
    }
  mkdirat(ctx->dirfd_min_rocks_write_fcntl_5_0_prog, tmp, S_IRWXU);
}

static inline void init_subdirs_min_rocks_write_fcntl_5_0_prog(thread_ctx_t *ctx) {
  for (int i = 0; i < num_subdirs_min_rocks_write_fcntl_5_0_prog; i++) {
    _mkdir_min_rocks_write_fcntl_5_0_prog(ctx, subdirs_min_rocks_write_fcntl_5_0_prog[i]);
  }
}

static void __attribute__((noinline)) remove_tmp_dir_min_rocks_write_fcntl_5_0_prog(const char *dir);
static inline void rm_tmpdir_min_rocks_write_fcntl_5_0_prog(thread_ctx_t *ctx) {
  remove_tmp_dir_min_rocks_write_fcntl_5_0_prog(ctx->tmpdir_min_rocks_write_fcntl_5_0_prog);
}

static inline char *bm_target_get_name(void) {
  return "min_rocks_write_fcntl_5_0";
}
...
static inline void bm_target_init(size_t init_size, size_t num_threads) {
  op_name_tbl[0] = "min_rocks_write_fcntl_5_0";
...
static inline void bm_target_reg(thread_ctx_t *ctx, size_t tid) {
  ...
  int fd_trunc = 0;
  tmpdir_template = strdup("./syzkaller_min_rocks_write_fcntl_5_0.XXXXXX");
  ctx->tmpdir_min_rocks_write_fcntl_5_0_prog = mkdtemp(tmpdir_template);
  chmod(ctx->tmpdir_min_rocks_write_fcntl_5_0_prog, S_IRWXU | S_IRWXG | S_IRWXO);
  ctx->dirfd_min_rocks_write_fcntl_5_0_prog = open(ctx->tmpdir_min_rocks_write_fcntl_5_0_prog, O_DIRECTORY | O_PATH);
  init_subdirs_min_rocks_write_fcntl_5_0_prog(ctx);
  ctx->num_succeeded_min_rocks_write_fcntl_5_0_prog = 0;
  ctx->num_failed_min_rocks_write_fcntl_5_0_prog = 0;

  assert(num_filenames_min_rocks_write_fcntl_5_0_prog == num_filesizes_min_rocks_write_fcntl_5_0_prog);

  for (int i = 0; i < num_filenames_min_rocks_write_fcntl_5_0_prog; i++) {
    fd_trunc = openat(ctx->dirfd_min_rocks_write_fcntl_5_0_prog, filenames_min_rocks_write_fcntl_5_0_prog[i],
                      O_RDWR | O_CREAT, S_IRWXU | S_IRWXG | S_IRWXO);
    // assert(fd_trunc > 0 && "Could not open file at thread registration");
    if (fd_trunc < 0)
      continue;
    int ret_ft = ftruncate(fd_trunc, filesizes_min_rocks_write_fcntl_5_0_prog[i]);
    (void)ret_ft;
    assert(ret_ft == 0);
    close(fd_trunc);
    fd_trunc = 0;
  ...
  ctx->mmap_offsets_min_rocks_write_fcntl_5_0_prog = (uintptr_t)(void *)mmap(
      NULL, MMAP_LENGTH, PROT_WRITE | PROT_READ | PROT_EXEC,
      MAP_ANONYMOUS | MAP_PRIVATE, (intptr_t)-1, 0ul);
  if (ctx->mmap_offsets_min_rocks_write_fcntl_5_0_prog == -1) {
    perror("mmap from syzkaller failed");
    assert(0 && "mmap from syzkaller failed");
  }

  assert(ctx->mmap_offsets_min_rocks_write_fcntl_5_0_prog);

  // allocate and fill write buffer
  // aligned to 4k block size of FS for O_DIRECT support
  if(maxWriteBufferSize_min_rocks_write_fcntl_5_0_prog > 0) {
    ctx->writeBuffer_min_rocks_write_fcntl_5_0_prog = (char *)aligned_alloc(maxWriteBufferSizeAlignment_min_rocks_write_fcntl_5_0_prog, maxWriteBufferSize_min_rocks_write_fcntl_5_0_prog);
  }
  else {
    ctx->writeBuffer_min_rocks_write_fcntl_5_0_prog = NULL;
  }

  if(maxWriteBufferSize_min_rocks_write_fcntl_5_0_prog % maxWriteBufferSizeAlignment_min_rocks_write_fcntl_5_0_prog != 0) {
  ...
  ctx->connect4_arg_min_rocks_write_fcntl_5_0_prog = saddr4_con;
  ...
  ctx->bind4_arg_min_rocks_write_fcntl_5_0_prog = saddr4_bind;

  // connect IPv6
  struct sockaddr_in6 *saddr6_con =
      (struct sockaddr_in6 *)malloc(sizeof(struct sockaddr_in6));
  ctx->connect6_arg_min_rocks_write_fcntl_5_0_prog = saddr6_con;
  ...
  struct sockaddr_in6 *saddr6_bind =
      (struct sockaddr_in6 *)malloc(sizeof(struct sockaddr_in6));
  ctx->bind6_arg_min_rocks_write_fcntl_5_0_prog = saddr6_bind;
...
static inline bm_op_res_t bm_dispatch_operation(thread_ctx_t *ctx,
  ...
  bm_dispatch_operation_min_rocks_write_fcntl_5_0_prog(ctx, op_id);
  res_all.op_count += ctx->num_succeeded_min_rocks_write_fcntl_5_0_prog + ctx->num_failed_min_rocks_write_fcntl_5_0_prog;
  res_all.succ_count += ctx->num_succeeded_min_rocks_write_fcntl_5_0_prog;
  ctx->iteration++;
  return res_all;
}

...
static void __attribute__((noinline)) remove_tmp_dir_min_rocks_write_fcntl_7_0_prog(const char *dir);
static inline void rm_tmpdir_min_rocks_write_fcntl_7_0_prog(thread_ctx_t *ctx) {
  remove_tmp_dir_min_rocks_write_fcntl_7_0_prog(ctx->tmpdir_min_rocks_write_fcntl_7_0_prog);
}
...
static inline void bm_target_reg(thread_ctx_t *ctx, size_t tid) {
  ...
  ctx->writeBuffer_min_rocks_write_fcntl_7_0_prog = (char *)malloc(maxWriteBufferSize_min_rocks_write_fcntl_7_0_prog);

...
//  ]
memcpy((void*)(0x20157140ul+PTR_OFFSET), "./#ib_16384_0.dblwr\000", 20);
	res = syscall(__NR_newfstatat, UNIQUE_VAR(ctx->dirfd), /*file=*/0x20157140ul+PTR_OFFSET, /*statbuf=*/0x20157180ul+PTR_OFFSET, /*flag=*/0ul);
...
//  ]
//  returns fd
memcpy((void*)(0x20157200ul+PTR_OFFSET), "./#ib_16384_0.dblwr\000", 20);
	res = syscall(__NR_openat, UNIQUE_VAR(ctx->dirfd), /*file=*/0x20157200ul+PTR_OFFSET, /*flags=O_CREAT|O_RDWR*/0x42, /*mode=S_IXOTH|S_IWOTH|S_IROTH|S_IXGRP|S_IWGRP|S_IRGRP|S_IXUSR|S_IWUSR|0x100*/0x1ff);
	if (res == -1 ) { assert(!abort_on_fail); UNIQUE_VAR(ctx->num_failed)++;} else {UNIQUE_VAR(ctx->num_succeeded)++;};
	if (res != -1)
...
//    }
//  ]
*(uint16_t*)(0x20157240ul+PTR_OFFSET) = 1;
*(uint16_t*)(0x20157242ul+PTR_OFFSET) = 0;
*(uint64_t*)(0x20157248ul+PTR_OFFSET) = 0;
*(uint64_t*)(0x20157250ul+PTR_OFFSET) = 0;
*(uint32_t*)(0x20157258ul+PTR_OFFSET) = 0;
	res = syscall(__NR_fcntl, /*fd=*/UNIQUE_VAR(ctx->r)[0], /*cmd=F_SETLK*/6ul, /*lock=*/0x20157240ul+PTR_OFFSET);
	if (res == -1 ) { assert(!abort_on_fail); UNIQUE_VAR(ctx->num_failed)++;} else {UNIQUE_VAR(ctx->num_succeeded)++;};
//  lseek arguments: [
//    fd: fd (resource)
...
//  ]
	res = syscall(__NR_pread64, /*fd=*/UNIQUE_VAR(ctx->r)[0], /*buf=*/0x201587c0ul+PTR_OFFSET, /*count=*/0x190000ul, /*pos=*/0ul);
	if (res == -1 ) { assert(!abort_on_fail); UNIQUE_VAR(ctx->num_failed)++;} else {UNIQUE_VAR(ctx->num_succeeded)++;};
//  close arguments: [
//    fd: fd (resource)
//  ]
...
memcpy((void*)(0x2019d680ul+PTR_OFFSET), "./#ib_16384_0.dblwr\000", 20);
	res = syscall(__NR_newfstatat, UNIQUE_VAR(ctx->dirfd), /*file=*/0x2019d680ul+PTR_OFFSET, /*statbuf=*/0x2019d6c0ul+PTR_OFFSET, /*flag=*/0ul);
	if (res == -1 ) { assert(!abort_on_fail); UNIQUE_VAR(ctx->num_failed)++;} else {UNIQUE_VAR(ctx->num_succeeded)++;};
//  openat arguments: [
//    fd: fd_dir (resource)
//    file: ptr[in, buffer] {
...
*(uint32_t*)(0x2019d798ul+PTR_OFFSET) = 0;
	res = syscall(__NR_fcntl, /*fd=*/UNIQUE_VAR(ctx->r)[1], /*cmd=F_SETLK*/6ul, /*lock=*/0x2019d780ul+PTR_OFFSET);
	if (res == -1 ) { assert(!abort_on_fail); UNIQUE_VAR(ctx->num_failed)++;} else {UNIQUE_VAR(ctx->num_succeeded)++;};
//  lseek arguments: [
//    fd: fd (resource)
//    offset: intptr = 0x0 (8 bytes)

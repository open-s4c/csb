...
const static char* UNIQUE_VAR(subdirs)[2] = {"./var/lib/mysql/performance_schema","var/lib/mysql"};
...
//  ]
memcpy((void*)(0x2010c340ul+PTR_OFFSET), "./var/lib/mysql/performance_schema", 34);
...
//  ]
//  returns fd
memcpy((void*)(0x20112f00ul+PTR_OFFSET), "./var/lib/mysql/performance_schema", 34);
	res = syscall(__NR_openat, UNIQUE_VAR(ctx->dirfd), /*file=*/0x20112f00ul+PTR_OFFSET, /*flags=O_NONBLOCK|O_DIRECTORY|O_CLOEXEC*/0x84800, /*mode=S_IXOTH|S_IWOTH|S_IROTH|S_IXGRP|S_IWGRP|S_IRGRP|S_IXUSR|S_IWUSR|0x100*/0x1ff);
	if (res == -1 ) { assert(!abort_on_fail); UNIQUE_VAR(ctx->num_failed)++;} else {UNIQUE_VAR(ctx->num_succeeded)++;};
	if (res != -1)
...
//    flag: statx_flags = 0x0 (8 bytes)
//  ]
memcpy((void*)(0x20113000ul+PTR_OFFSET), "./var/lib/mysql/performance_schema", 34);
	res = syscall(__NR_newfstatat, UNIQUE_VAR(ctx->dirfd), /*file=*/0x20113000ul+PTR_OFFSET, /*statbuf=*/0x20113040ul+PTR_OFFSET, /*flag=*/0ul);
	if (res == -1 ) { assert(!abort_on_fail); UNIQUE_VAR(ctx->num_failed)++;} else {UNIQUE_VAR(ctx->num_succeeded)++;};
...
//  ]
	res = syscall(__NR_getdents64, /*fd=*/UNIQUE_VAR(ctx->r)[0], /*ent=*/0x201130c0ul+PTR_OFFSET, /*count=*/0x8000ul);
	if (res == -1 ) { assert(!abort_on_fail); UNIQUE_VAR(ctx->num_failed)++;} else {UNIQUE_VAR(ctx->num_succeeded)++;};
//  getdents64 arguments: [
//    fd: fd_dir (resource)
//    ent: ptr[out, buffer] {
...
//    count: len = 0x8000 (8 bytes)
//  ]
	res = syscall(__NR_getdents64, /*fd=*/UNIQUE_VAR(ctx->r)[0], /*ent=*/0x2011d600ul+PTR_OFFSET, /*count=*/0x8000ul);
	if (res == -1 ) { assert(!abort_on_fail); UNIQUE_VAR(ctx->num_failed)++;} else {UNIQUE_VAR(ctx->num_succeeded)++;};
//  close arguments: [
//    fd: fd (resource)
//  ]
...
//    flag: statx_flags = 0x0 (8 bytes)
//  ]
memcpy((void*)(0x20153d80ul+PTR_OFFSET), "./var/lib/mysql/performance_schema", 34);
	res = syscall(__NR_newfstatat, UNIQUE_VAR(ctx->dirfd), /*file=*/0x20153d80ul+PTR_OFFSET, /*statbuf=*/0x20153dc0ul+PTR_OFFSET, /*flag=*/0ul);
	if (res == -1 ) { assert(!abort_on_fail); UNIQUE_VAR(ctx->num_failed)++;} else {UNIQUE_VAR(ctx->num_succeeded)++;};
//  newfstatat arguments: [
//    dfd: const = 0xffffffffffffff9c (8 bytes)
//    file: ptr[in, buffer] {
...
//    flag: statx_flags = 0x0 (8 bytes)
//  ]
memcpy((void*)(0x20153e40ul+PTR_OFFSET), "./var/lib/mysql/performance_schema", 34);
	res = syscall(__NR_newfstatat, UNIQUE_VAR(ctx->dirfd), /*file=*/0x20153e40ul+PTR_OFFSET, /*statbuf=*/0x20153e80ul+PTR_OFFSET, /*flag=*/0ul);
	if (res == -1 ) { assert(!abort_on_fail); UNIQUE_VAR(ctx->num_failed)++;} else {UNIQUE_VAR(ctx->num_succeeded)++;};
//  newfstatat arguments: [
//    dfd: const = 0xffffffffffffff9c (8 bytes)
//    file: ptr[in, buffer] {
...
//    flag: statx_flags = 0x0 (8 bytes)
//  ]
memcpy((void*)(0x2019acc0ul+PTR_OFFSET), "./var/lib/mysql/performance_schema", 34);
	res = syscall(__NR_newfstatat, UNIQUE_VAR(ctx->dirfd), /*file=*/0x2019acc0ul+PTR_OFFSET, /*statbuf=*/0x2019ad00ul+PTR_OFFSET, /*flag=*/0ul);
	if (res == -1 ) { assert(!abort_on_fail); UNIQUE_VAR(ctx->num_failed)++;} else {UNIQUE_VAR(ctx->num_succeeded)++;};
//  newfstatat arguments: [
//    dfd: const = 0xffffffffffffff9c (8 bytes)
//    file: ptr[in, buffer] {
